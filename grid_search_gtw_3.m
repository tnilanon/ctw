...
par_cca_d_list = [0.3, 0.4, 0.5, 0.6];
par_cca_lambda_list = [0.94, 0.96, 0.98];
...
for par_cca_d = par_cca_d_list
    for par_cca_lambda = par_cca_lambda_list
        ...
        fprintf('d: %.2f; lambda: %.1f; started @ %s\n', par_cca_d, par_cca_lambda, datetime);
        ...
        [grid_search_result(idx_result).pct_15f_begin, ...
            ...
            ] = eval_pct_mae_within_x_frames(gtw_mae_arr, 15);
        ...
        [grid_search_result(idx_result).pct_30f_begin, ...
            ...
            ] = eval_pct_mae_within_x_frames(gtw_mae_arr, 30);
